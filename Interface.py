...
industry_risk_map = {
    "IT/소프트웨어": {
        "랜섬웨어":1.0,"제로데이":1.0,"취약점":0.9,"API":0.8,"클라우드":0.9,"SaaS":0.8,"DevOps":0.7,"GitHub":0.7,
        "오픈소스":0.7,"CVE":1.0,"패치":0.9,"익스플로잇":1.0,"공급망 공격":0.9,"소프트웨어 업데이트":0.8,"악성코드":1.0,
        "백도어":1.0,"웹쉘":0.9,"SQL 인젝션":1.0,"XSS":1.0,"CSRF":0.9,"SSRF":0.9,"XXE":0.9,"IDOR":0.8,
        "버퍼 오버플로우":1.0,"메모리 누수":0.8,"권한 상승":0.9,"세션 하이재킹":0.9,"세션 고정":0.8,"취약한 암호화":1.0,
        "하드코딩된 키":0.8,"평문 전송":0.9,"API 키 노출":1.0,"크리덴셜 스터핑":1.0,"브루트포스":0.9,"딕셔너리 공격":0.9,
        "피싱":0.8,"스피어피싱":0.9,"워터링홀":0.8,"APT":1.0,"사회공학":0.9,"악성 스크립트":0.8,"웹 취약점":0.8,
        "코드 서명 위조":0.9,"취약한 라이브러리":0.9,"npm 패키지 공격":0.8,"PyPI 공격":0.8,"맬웨어":1.0,
        "RAT":0.9,"루트킷":0.9,"로직밤":0.8,"봇넷":0.9,"웜":0.9,"바이러스":0.9,
        "CI/CD 공격":0.8,"컨테이너 탈출":0.9,"쿠버네티스 공격":0.9,"도커 허브 악성 이미지":0.8,
        "IaC 보안":0.7,"취약한 설정":0.9,"잘못된 권한":0.9,"IAM 오용":0.9,"S3 버킷 노출":1.0,
        ...
        "보안 설정 미흡":0.8,"권한 오남용":0.9,"암호화 미적용":0.9,"데이터 유출":1.0,"소스코드 유출":0.9,
        "DevSecOps 미흡":0.8,"취약한 테스트 코드":0.7,"보안 자동화 부재":0.7,"취약점 스캐닝 누락":0.8,
        "보안 로그 미수집":0.8,"SIEM 부재":0.8,"EDR 미적용":0.8,"MFA 미적용":0.9,"약한 비밀번호":1.0,
        "OAuth 취약점":0.9,"SSO 우회":0.9,"JWT 변조":0.9,"GraphQL 공격":0.9,"NoSQL 인젝션":0.9,
        "API 게이트웨이 우회":0.8,"클라우드 네이티브 공격":0.9,"IaC 스캔 누락":0.8,"CSP 설정 오류":0.8,
        "안전하지 않은 리다이렉트":0.8,"세션 토큰 재사용":0.9,"쿠키 탈취":0.9,"브라우저 익스플로잇":0.9,
        "제로트러스트 미적용":0.8,"망 분리 우회":0.9,"보안 모니터링 부재":0.8
    },
    "제조업": {
        "산업제어시스템":1.0,"SCADA":1.0,"ICS":1.0,"PLC":1.0,"스마트팩토리":0.9,"로봇":0.8,"CNC":0.8,"HMI":0.9,
        "산업용 IoT":0.9,"OT 보안":1.0,"제조 라인 공격":0.9,"공급망 공격":1.0,"악성 USB":0.8,
        "랜섬웨어":1.0,"트로이목마":0.9,"워터링홀":0.8,"APT":1.0,"스피어피싱":0.9,"사회공학":0.8,
        "데이터 유출":1.0,"생산 차질":0.9,"로봇 해킹":0.8,"CVE":1.0,"제로데이":1.0,"악성코드":1.0,
        "VPN 공격":0.9,"MITM":0.9,"DoS":0.8,"DDoS":1.0,"버퍼 오버플로우":0.9,"메모리 취약점":0.9,
        "권한 상승":0.9,"세션 하이재킹":0.8,"백도어":0.9,"봇넷":0.9,"웜":0.8,"루트킷":0.8,"RAT":0.8,
        "스마트센서":0.8,"IoT 보안":0.9,"펌웨어 해킹":0.9,"취약한 암호화":0.9,"하드코딩된 키":0.8,"평문 통신":0.8,
        "원격 코드 실행":0.9,"SQL 인젝션":0.9,"XSS":0.8,"SSRF":0.8,"CSRF":0.8,"웹 취약점":0.8,
        "공장 자동화 공격":0.9,"제조 데이터 위조":0.9,"스파이웨어":0.8,"산업 스파이":0.9,"설비 파괴":1.0,
        "위조 부품":0.9,"불량품 주입":0.9,"생산 중단":1.0,"국가 지원 해킹":1.0,"라자루스":1.0,
        "샌드움":1.0,"APT41":1.0,"기계 제어 취약점":0.9,"산업 네트워크 침투":0.9,"보안 설정 미흡":0.8,
        "접근 통제 실패":0.9,"데이터 무결성 공격":0.9,"위조 인증서":0.9,"인증 우회":0.9,"악성 펌웨어":1.0,
        "Modbus 공격":0.9,"DNP3 공격":0.9,"HMI 위조":0.8,"산업 로봇 제어권 탈취":0.9,
        "에너지 관리시스템 공격":0.9,"PLC 로직 주입":0.9,"산업 네트워크 스니핑":0.8,"망분리 우회":0.9
    },
    "금융업": {
        "피싱":1.0,"스피어피싱":1.0,"이메일 계정 탈취":1.0,"계정정보 유출":1.0,"크리덴셜 스터핑":1.0,
        "브루트포스":1.0,"딕셔너리 공격":1.0,"계좌 탈취":1.0,"은행":1.0,"카드사":0.9,"결제정보 유출":1.0,
        "암호화폐":1.0,"거래소 해킹":1.0,"DeFi 공격":1.0,"핀테크":0.9,"오픈뱅킹":0.9,"API 키 노출":1.0,
        "랜섬웨어":0.9,"트로이목마":0.9,"악성코드":0.9,"봇넷":0.9,"RAT":0.9,"루트킷":0.8,
        "APT":1.0,"사회공학":0.9,"BEC":1.0,"가짜 앱":0.9,"모바일 피싱":1.0,"스미싱":1.0,"QR 피싱":0.9,
        "DDoS":1.0,"서비스 거부":0.9,"MITM":1.0,"DNS 스푸핑":0.9,"패킷 스니핑":0.9,
        "악성 결제 모듈":1.0,"백도어":0.9,"정보 탈취":1.0,"데이터 유출":1.0,
        "고객정보 유출":1.0,"금융사기":1.0,"보이스피싱":1.0,"가짜 투자":1.0,"라자루스":1.0,"김수키":0.9,
        "APT38":1.0,"국가 지원 해킹":1.0,"SWIFT 공격":1.0,"ATM 해킹":0.9,"POS 공격":0.9,
        "핀테크 API 취약점":0.9,"암호화 미적용":1.0,"약한 비밀번호":1.0,"2FA 미적용":1.0,
        "세션 탈취":0.9,"토큰 탈취":0.9,"불법 송금":1.0,"악성 봇":0.9,"딥페이크 사기":0.9,
        "대출 사기":0.9,"가짜 보험":0.8,"모바일 뱅킹 악성앱":0.9,"핀테크 SDK 취약점":0.9,
        "암호화폐 탈취":1.0,"피싱 웹사이트":1.0,"가짜 인증서":0.9,"MFA 피싱":0.9
    },
    "의료업": {
        ...
        "제로데이":1.0,"취약점":1.0,"CVE":1.0,"SQL 인젝션":0.9,"XSS":0.9,"CSRF":0.9,
        "SSRF":0.9,"서비스 거부":0.9,"DDoS":1.0,"MITM":0.9,"VPN 공격":0.9,
        "의료데이터 위조":1.0,"환자 모니터링 조작":0.9,"의료기기 오작동":1.0,
        "불법 의료 데이터 거래":1.0,"다크웹 유출":1.0,"악성 앱":0.9,"위조 처방전":0.9,
        "보안 설정 미흡":0.9,"암호화 미적용":1.0,"약한 비밀번호":1.0,"2FA 미적용":1.0,
        "의료 AI 위조":0.9,"헬스케어 IoT 공격":0.9,"환자 계정 탈취":0.9,"의료보험 사기":0.9
    },
    "교육업": {
        "온라인수업":1.0,"LMS":1.0,"학생정보":1.0,"교직원 계정":1.0,"학교 네트워크":0.9,
        "연구데이터":0.9,"대학 해킹":1.0,"고등학교 해킹":0.9,"입시 데이터 유출":1.0,"성적 조작":1.0,
        "피싱":1.0,"스피어피싱":1.0,"스미싱":1.0,"QR 피싱":0.9,"사회공학":0.9,
        "랜섬웨어":1.0,"악성코드":1.0,"트로이목마":0.9,"웜":0.9,"바이러스":0.9,"RAT":0.9,
        "제로데이":1.0,"취약점":1.0,"SQL 인젝션":0.9,"XSS":0.9,"CSRF":0.9,
        "SSRF":0.9,"서비스 거부":0.9,"DDoS":1.0,"MITM":0.9,"VPN 공격":0.9,
        "데이터 유출":1.0,"개인정보 유출":1.0,"출석 조작":0.9,"시험 문제 유출":1.0,
        "해킹 동아리":0.7,"다크웹 공유":0.9,"크리덴셜 스터핑":1.0,"브루트포스":0.9,"약한 암호":1.0,
        "원격 수업 툴 공격":0.9,"교수 계정 탈취":0.9,"학생 계정 도용":0.9,"교육 클라우드 취약점":0.9
    },
    "기타": {
        "APT":1.0,"라자루스":1.0,"김수키":1.0,"샌드웜":1.0,"APT28":1.0,"APT29":1.0,
        "국가 지원 해킹":1.0,"사이버전":1.0,"사이버 스파이":1.0,"스파이웨어":0.9,
        "사회공학":0.9,"정치 선전 해킹":0.9,"정부기관 공격":1.0,"군사 해킹":1.0,
        "DDoS":1.0,"서비스 거부":0.9,"데이터 유출":1.0,"기밀 문서 유출":1.0,
        "랜섬웨어":1.0,"제로데이":1.0,"취약점":0.9,"악성코드":1.0,"백도어":1.0,
        "스피어피싱":1.0,"BEC":0.9,"공급망 공격":1.0,"소셜미디어 해킹":0.9,"디도스":1.0,
        "선거 해킹":1.0,"언론 조작":0.9,"인프라 공격":1.0,"전력망 공격":1.0,"수도시설 공격":0.9,
        "교통망 해킹":0.9,"위성통신 해킹":0.9,"GPS 교란":0.9,"IoT 공격":0.9,
        "딥페이크":0.9,"AI 기반 공격":0.9,"악성 드론":0.8,"사이버 테러":1.0,"핵심인프라 파괴":1.0,
        "MITRE ATT&CK TTP":0.9,"사회 혼란 조장":1.0,"사이버 첩보":1.0
    }
}
...
def generate_playbook_with_llm(keywords, company_info, detail_level, infrastructure, constraints, news_briefs=None):
    """
...
with st.sidebar:
    ...
    st.subheader("🧪 LLM 상세도")
    detail_level = st.selectbox("응답 상세도", ["상", "중", "하"], index=0)
    ...
    if st.button("🔍 분석 시작", type="primary"):
        ...
        with st.spinner("상위 뉴스 요약 정리 중..."):
            ...
            for n in top_for_brief:
                brief = f"{n['title']} | 키워드: {', '.join(n['keywords'][:3])} | 위험도 {n['risk_level']}"
        ...
        with st.spinner("LLM 플레이북 생성 중..."):
            ...
            st.session_state.playbook_content = generate_playbook_with_llm(
                keywords_list, company_info, detail_level, infrastructure, constraints, news_briefs=news_briefs
            )
...
# ============================================================
# 8) 탭: 대시보드/뉴스/키워드/플레이북/보고서
# ============================================================
tab1, tab2, tab3, tab4, tab5 = st.tabs([
    "📊 대시보드", "📰 뉴스 분석", "🎯 관심 키워드", "📋 대응 플레이북", "📄 보고서 다운로드"
])
...
with tab1:
    ...
    if 'analysis_started' not in st.session_state:
        ...
        if not top_news:
            ...
            if 'current_news_idx' not in st.session_state or st.session_state.current_news_idx >= len(top_news):
                st.session_state.current_news_idx = 0
            current = top_news[st.session_state.current_news_idx]
            company_info = {"name": "중소기업", "size": company_size, "industry": industry_type}
            summary = generate_article_summary(
                ...
                current['risk_level'],
                company_info,
                st.session_state.get("infrastructure", ""),
            )
            ...
            <div class="news-item {css_class}">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
                    ...
                    <span style="background:{'#e74c3c' if current['risk_level']=='높음' else '#f39c12' if current['risk_level']=='중간' else '#27ae60'};color:white;padding:0.3rem 0.8rem;border-radius:15px;font-size:0.8rem;font-weight:bold;">
            ...
            c1, c2 = st.columns(2)
            with c1:
                if st.button("< 이전", key='dash_prev', disabled=st.session_state.current_news_idx == 0):
                    st.session_state.current_news_idx -= 1
            with c2:
                if st.button("다음 >", key='dash_next', disabled=st.session_state.current_news_idx == len(top_news) - 1):
                    st.session_state.current_news_idx += 1
...
with tab2:
    ...
    if 'analysis_started' not in st.session_state:
        ...
        interest_keywords = [kw.strip().lower() for kw in st.session_state.get('user_interest', "").split(',') if kw.strip()]
        sorted_news = sorted(
            st.session_state.news_data,
            key=lambda n: (
                sum(1 for kw in interest_keywords if kw in n['title'].lower() or kw in n['full_content'].lower()),
                n['risk_score']
            ),
            reverse=True
        )
        if interest_keywords:
            st.info(f"입력한 관심 키워드 우선 정렬: {', '.join(interest_keywords)}")
        page_size = 10
        ...
        for news in page_data:
            ...
            <div class="news-item {css_class}">
                ...
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    <div><strong>키워드:</strong> {', '.join(news['keywords'])}</div>
                    <div style="color:#888;font-size:0.9rem;">{news['source']} | {news['published']}</div>
                </div>
            </div>
            """, unsafe_allow_html=True)
            with st.expander("🔍 분석 메모"):
                st.markdown(f"- 키워드 기반 가중치 합산 결과입니다.\n- 상위 키워드: {', '.join(news['keywords'][:3])}")
        st.divider()
...
# --- 관심 키워드
with tab3:
    st.header("🎯 추출된 관심/위험 키워드")
    if 'analysis_started' not in st.session_state:
        st.info("👈 사이드바에서 '분석 시작'을 눌러주세요.")
    else:
        col1, col2 = st.columns(2)
        high_cnt = sum(1 for k in st.session_state.risk_keywords if k['risk_level'] == '높음')
        with col1:
            st.metric("총 추출 키워드", f"{len(st.session_state.risk_keywords)}개")
        with col2:
            st.metric("높은 위험도 키워드", f"{high_cnt}개")
        st.divider()
        def badge(level: str):
            return {"높음":"🔴","중간":"🟡","낮음":"🟢"}.get(level, "⚪")
        for kw in st.session_state.risk_keywords:
            c1, c2, c3 = st.columns([3,1,1])
            with c1: st.markdown(f"**{kw['keyword']}** {badge(kw['risk_level'])}")
            with c2: st.markdown(f"빈도: **{kw['frequency']}**")
            with c3: st.markdown(f"레벨: **{kw['risk_level']}**")
...
with tab4:
    ...
    if 'analysis_started' not in st.session_state:
        ...
        st.markdown(
            f"""<div class="recommendation-box"><h3>🛡️ 맞춤형 대응 플레이북</h3>
